...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == ADD_NOTE_REQUEST && resultCode == RESULT_OK) {
            ...
            if (id==-1){
                Toast.makeText(this, "Notiz NICHT gespeichert", Toast.LENGTH_SHORT).show();
                return;
            }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case R.id.delete_all_notes:
                ...
                Toast.makeText(this, "Alle Notizen gelöscht", Toast.LENGTH_SHORT).show();
                return true;
            case R.id.show_all_categories:
                Intent intent = new Intent(MainActivity.this, CategoryActivity.class);
                startActivity(intent);

                Toast.makeText(this, "Kategorien anzeigen", Toast.LENGTH_SHORT).show();
